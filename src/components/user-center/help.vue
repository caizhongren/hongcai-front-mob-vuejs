  ...
  <div class="help">
    ...
    <div v-if="type === '1'">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            国资背景<br/>1) 2016年获国有企业1亿元A轮战略投资<br>2) 新三板金控第一股入主<br>3) 拥有博士高管团队的互联网金融平台<br><br/>
            银行存管<br/>1) 2016年加入网贷协会，首批接入北京存管通平台，所有投资信息实时上传北京金融局等监管部门<br>2) 2017年6月正式上线海口联合农商银行资金存管，实现银行级资金安全保障<br><br/>
            风控安全<br/>1) 十年多金融生态圈，积累优质资产<br>2) 银行级存管确保用户投资资金万无一失<br>3) 所有项目借款方知根知底，铸造闭环征信体系<br><br/>
    ...
    <div v-if="type === '2'">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            1) 宏财精选系列：6个月以下中短期投资产品，极为灵活轻便，同时具有较高的回报水准。债权精选自小微产业金融、汽车金融及个人信用贷款等，安全可靠。<br><br>
            2) 宏财尊贵系列：6-12月中长期投资产品，受到追求更高投资回报和更省心投资体验的高净值投资者的普遍青睐。债权来自信用状况极佳的小微产业金融、以汽车为主的消费金融及个人信用贷款等，安全可靠。<br><br>
    ...
    <div v-if="type === '3'">
      ...
      <div class="content">
        <div class="column" @click="showOrHide($event)">
          <div class="fl">6.债权转让实际支付金额为何会大于认购金额？</div>
          <div class="fa-down txt-right fr">
          </div>
        </div>
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            实际支付金额 = 转让金额 + 当期已产生的待偿利息 - 转让奖金。<br><br>
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            该笔债权持有时间 < 30天，手续费 = 转让本金 * 1%，<br>持有时间 ≥ 30天，手续费 = 转让本金 * 0.5%，<br>单笔转让的手续费最低为3元。
          </span>  
        </div>
      </div>
      <div class="content">
    ...
    <div v-if="type === '4'">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            打开【我的】页面，点击左上角【设置】，进入设置页面后选择【手机号】，进入更改绑定手机号页面，按照流程提示完成更换手机号操作。
          </span>  
        </div>
      </div>
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            在【登录】页面按钮下方点击【忘记密码】，根据页面引导输入图形验证码、短信验证码验证成功后，重新设置登录密码即可。
          </span>  
        </div>
      </div>
      <div class="content">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            打开【我的】页面，点击左上角【设置】，进入设置页面后选择【密码管理】<br>
            修改登录密码：选择【登录密码】>>【去修改】>>进行登录密码修改<br>
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            如果您在注册或登录过程中，点击“获取验证码”按钮后手机一直收不到验证码，建议等60秒，并查看是否被手机内安全软件拦截，或先重启下您的手机，排除手机自身原因后，再次获取验证码。如果依旧收不到验证码，您可以拨打宏财网客服电话：400-9907-626进行咨询。
          </span>  
        </div>
      </div>
      <div class="content">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            1）账户登录不上，建议您清除下手机缓存或者关机重启后，然后重新进入，如果还不能登录建议联系客服，客服电话：400-990-7626。<br>
            2）若app不能正常更新，可尝试卸载之前的版本，然后再去应用商城重新安装。
          </span>
        </div>
      </div>
    </div>
    ...
    <div v-if="type === '5'">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            若没有开通过银行存管账户，则打开【我的】页面>>点击【充值】/【提现】>>点击>>根据页面提示信息进行操作；若已经绑定过银行卡，则打开【我的】页面，点击左上角【设置】，进入设置页面后选择【银行卡】，进入银行卡管理页面，可进行解绑，再次绑定操作。
          </span>  
        </div>
      </div>
      <div class="content">
    ...
    <div v-if="type === '6'">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            打开【我的】页面，点击【设资金流水】， >>点击右上角【筛选】可以查看历史的【投资】、【充值】、【提现】、【回款】、【奖励】、【其他】记录。
          </span>  
        </div>
      </div>
      <div class="content">
