  ...
  <div class="help">
    ...
    <div v-if="type === '3'">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            1）当前项目持有时间<30天时，手续费=转让本金×1%；<br><br>
            2）当前项目持有时间≥30天，手续费=转让本金×0.5%；<br><br>
            3）单笔转让手续费最低为3元。
          </span>  
        </div>
      </div>
    ...
    <div v-if="type === '5'">
      ...
      <div class="content">
        ...
        <div class="submenu">
          <span class="padding-l-1 ft-grey7 display-inb padding-b-1p2">
            如您绑定的银行卡出现问题或需要更换，请先解绑后重新进行绑定。<br><br>
            解绑银行卡的具体操作如下：<br><br>
            需要您先申请解绑当前银行卡，再绑定您本人名下新的银行卡。为保证资金安全，需确认是本人操作，请发送以下材料到我们的客服邮箱hckf@hongcai.com申请人工解绑，客服会在1-2个工作日内处理。<br><br>
