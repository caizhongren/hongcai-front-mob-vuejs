								...
								<ul class="">
									...
									<li>
										<p>
											...
											2.如邀请的新用户于注册日起90天内进行出借，老用户可获得其首投日起未来60天内，该好友每笔出借折合年化出借金额x2%的佣金返现，可从单个好友处获得佣金上限为1000元，可邀请好友人数无上限。
										</p>
									</li>
									<li>
										<p>
									...
									<li>
										<p>
											<span>【关于特权本金】</span>
											特权本金是平台向用户提供的一种虚拟资金，其本身不可提现或作为出借资金，但享受8%期望年均回报率。特权本金次日即可产生利息，并直接发放至用户可用余额，可用于提现或作为出借资金。<br>
											本活动最终解释权归宏财网所有
                    </p>
									</li>
								</ul>
