  ...
  <div>
    ...
    <div class="agreement-area row" v-if="contractType === 10">
      ...
      <div class="row">
        ...
        <br>
        <p><strong class="agree-mg">鉴于：</strong></p>
        <p class="agree-tx">1、甲方（同一借款标的项下的每一个出借人各自独立出借款项，均称为“甲方”）为平台的注册用户，有资金出借的需求。</p>
        ...
        <p class="agree-tx" v-if="!contracts.total">3、借款年化利率<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>%（月利率=年化利率/12；日利率=年化利率/365），以存管银行将甲方出借资金转入乙方存管账户之日作为利息起算日，不足一月的按日计息。甲方出借资金自充值到甲方存管账户至转入乙方存管账户期间不计算利息。</p>
        ...
        <p class="agree-tx">3、经协商一致，乙方在本合同项下的还款方式为：按月付息，到期一次性还本，即乙方每月支付一次利息，借款到期日一次性偿还全部借款本金。乙方首次利息的支付时间为借款发放日后的第30天，后续每月利息的支付时间以此类推。如最后一次利息的支付时间不满30天的，以借款到期日作为最后一次利息的支付日,必要时上一期利息也可在最后一期同时支付。</p>
        <p class="agree-tx">具体还款日期及还款金额详见《还款计划表》。</p>
        <p class="agree-tx">4、乙方应按照《还款计划表》的约定及时将应还本金和/或利息转入乙方存管账户。乙方授权丙方向存管银行发出付款指令，将当期乙方应向甲方偿还的金额，按本合同约定时间从乙方存管账户转入甲方存管账户，完成乙方的还款。</p>
        ...
        <p class="agree-tx">7、乙方还款金额进入甲方存管账户后，甲方可提现或进行平台其他项目的出借。</p>
        <br>
        <p><strong class="agree-mg">三、提前还款</strong></p>
        <p class="agree-tx">1、出借款项转入乙方存管账户之日起不满<u> 30 </u>日（含）的，原则上不允许提前还款，除非乙方同意支付前述期间的全部利息。出借款项转入乙方存管账户起<u> 30 </u>日（不含）后，乙方可申请提前还款，并按照实际借款期间支付利息，具体流程如下：</p>
        <p class="agree-tx">（1）乙方有意向提前还款的，应提前 3个工作日向丙方提出申请，并明确拟提前还款日期。经丙方审核确认乙方提前还款符合本合同约定的，则通知乙方同意配合其履行提前还款。</p>
        ...
        <p class="agree-tx">（2）甲方已经充分认识到向乙方出借资金可能存在的风险，经独立审慎判断后做出出借决定，自愿签署本合同，由此产生的一切风险均由甲方自行承担。</p>
        ...
        <p class="agree-tx">（7）如乙方未按照本合同约定按时归还借款本息，任何一期逾期达到<u> 15 </u>日的，甲方授权丙方代甲方向乙方宣布本合同提前到期，乙方应立即履行还本付息及其他款项的支付义务。</p>
        <p class="agree-tx">（8）甲方承诺，甲方因出借资金而应承担的相关税费，由甲方自行向税务机关申报、缴纳，丙方不负责相关事项的处理。如因此导致丙方承担责任或遭受损失，丙方有权向甲方追偿。</p>
        <p class="agree-tx">（9）甲方确认，甲方通过本合同对丙方的授权不可撤销，丙方依据该等授权所进行的一切行为的法律后果由甲方承担。</p>
        <p class="agree-tx">（10）甲方知悉并确认，甲方存管账户中的拟出借款项在划转至乙方存管账户之日前被冻结且不计息。甲方存管账户中的拟出借款项被冻结后，甲方不得要求解除冻结或申请用于其他出借。</p>
        <p class="agree-tx">（11）甲方应妥善保管其在平台的用户名和密码，通过该用户名和密码进行登录的任何操作均被视为甲方的行为，所产生的一切法律后果由甲方承担。</p>
        <p class="agree-tx">2、乙方的陈述、声明和保证</p>
        <p class="agree-tx">（1）乙方保证具有签署本合同的民事权利能力和民事行为能力，能独立承担民事责任。如需授权批准，乙方保证本次向甲方借款已经获得了必要的授权批准。如需履行必要的内部审批程序，甲方保证其签署和履行本合同已经履行了必要的内部程序。</p>
        ...
        <p class="agree-tx">3、乙方同意，若乙方任何一期应付款项逾期超过15日（含），或乙方逾期后出现逃避、拒绝沟通或拒不承认欠款、失去联系等恶意行为，丙方有权依法将乙方的违约失信信息在平台网站进行公告，或以其他适当的方式公开披露。</p>
        <p class="agree-tx">4、如乙方未能按照本合同约定及时足额还款，乙方不可撤销地授权丙方指令存管银行随时划转乙方存管账户中的余额（如有）用以偿付乙方到期借款本息及其他费用（如有），该等划转无需另行征得乙方同意或通知乙方。</p>
        <br>
        <p><strong class="agree-mg">八、法律适用和争议解决</strong></p>
        <p class="agree-tx">1、本合同适用中华人民共和国法律解释。</p>
        <p class="agree-tx">2、本合同履行过程中如发生争议，应友好协商解决，协商不成的，任何一方均可向丙方注册在地北京市石景山区有管辖权的人民法院诉讼解决。</p>
        <br>
        <p><strong class="agree-mg">九、本合同的成立及生效</strong></p>
    ...
    <div class="agreement-area row" v-if="contractType === 12">
      ...
      <div class="row">
        ...
        <br>
        <p><strong class="agree-mg">鉴于：</strong></p>
        <p class="agree-tx">1、甲方（同一借款标的项下的每一个出借人各自独立出借款项，均称为“甲方”）为平台的注册用户，有资金出借的需求，有意向通过宏财网平台向乙方提供借款。</p>
        <p class="agree-tx">2、乙方有借款需求，有意向通过宏财网平台向甲方借款。</p>
        <p class="agree-tx">3、丙方愿意为乙方在本合同项下还款义务的履行向甲方提供连带责任保证担保。</p>
        <p class="agree-tx">4、丁方是一家在北京市合法成立并有效存续的有限责任公司，是宏财网（hongcai.com）及对应的移动客户端（统称为“宏财网”或“平台”）的运营主体，为借贷双方提供信息发布、资信评估、信息交互及借贷交易撮合等服务。</p>
        <br>
        ...
        <p class="agree-tx">3、经协商一致，乙方在本合同项下的还款方式为：按月付息，到期一次性还本，即乙方每月支付一次利息，借款到期日一次性偿还全部借款本金。乙方首次利息的支付时间为借款发放日后的第30天，后续每月利息的支付时间以此类推。如最后一次利息的支付时间不满30天的，以借款到期日作为最后一次利息的支付日,必要时上一期利息也可在最后一期同时支付。</p>
        <p class="agree-tx">具体还款日期及还款金额详见《还款计划表》。</p>
        <p class="agree-tx">4、乙方应按照《还款计划表》的约定及时将应还本金和/或利息转入乙方存管账户。乙方授权丁方向存管银行发出付款指令，将当期乙方应向甲方偿还的金额，按本合同约定时间从乙方存管账户转入甲方存管账户，完成乙方的还款。</p>
        <p class="agree-tx">5、乙方将当期应还本息转入乙方存管账户的时间应不迟于当期约定还款日中午12:00。</p>
        <p class="agree-tx">6、乙方确认，如乙方还款金额不足以清偿其到期应付款项，则按照如下顺序进行清偿：债权人实现债权的费用、违约金、利息、本金。</p>
        <p class="agree-tx">7、乙方还款金额进入甲方存管账户后，甲方可提现或进行平台其他项目的出借。</p>
        <br>
        <p><strong class="agree-mg">三、提前还款</strong></p>
        <p class="agree-tx">1、出借款项转入乙方存管账户之日起不满<u> 30 </u>日（含）的，原则上不允许提前还款，除非乙方同意支付前述期间的全部利息。出借款项转入乙方存管账户起<u> 30 </u>日（不含）后，乙方可申请提前还款，并按照实际借款期间支付利息，具体流程如下：</p>
        <p class="agree-tx">（1）乙方有意向提前还款的，应提前<u> 3 </u>个工作日向丁方提出申请，并明确拟提前还款日期。经丁方审核确认乙方提前还款符合本合同约定的，则通知乙方同意配合其履行提前还款。</p>
        ...
        <p class="agree-tx">（7）如乙方未按照本合同约定按时归还借款本息，任何一期逾期达到<u> 15 </u>日的，甲方授权丁方代甲方向乙方宣布本合同提前到期，乙方应立即履行还本付息及其他款项的支付义务。</p>
        <p class="agree-tx">（8）甲方承诺，甲方因出借资金而应承担的相关税费，由甲方自行向税务机关申报、缴纳，丁方不负责相关事项的处理。如因此导致丁方承担责任或遭受损失，丁方有权向甲方追偿。</p>
        <p class="agree-tx">（9）甲方确认，甲方通过本合同对丁方的授权不可撤销，丁方依据该等授权所进行的一切行为的法律后果由甲方承担。</p>
        <p class="agree-tx">（10）甲方知悉并确认，甲方存管账户中的拟出借款项在划转至乙方存管账户之日前被冻结且不计息。甲方存管账户中的拟出借款项被冻结后，甲方不得要求解除冻结或申请用于其他出借。</p>
        <p class="agree-tx">（11）甲方应妥善保管其在平台的用户名和密码，通过该用户名和密码进行登录的任何操作均被视为甲方的行为，所产生的一切法律后果由甲方承担。</p>
        <p class="agree-tx">2、乙方的陈述、声明和保证</p>
        ...
        <p class="agree-tx">（5）乙方保证，在其清偿完毕本合同项下的还款义务前，不进行对外出借、实质性增加债务融资等足以影响本合同项下义务履行的行为。如乙方确要进行前述行为，应提前通知丁方，并向甲方提供相应的担保措施或履行提前还款义务。</p>
        ...
        <p class="agree-tx">3、丙方逾期履行保证担保责任的，每逾期一日，应按照逾期代偿金额的【 0.03 】%向债权人支付违约金，直至代偿完毕止。</p>
        ...
        <p class="agree-tx">5、乙方、丙方同意，若乙方任何一期应付款项逾期超过15日（含），或乙方逾期后出现逃避、拒绝沟通或拒不承认欠款、失去联系等恶意行为，或丙方拒绝履行保证担保责任达到15日，丁方有权依法将乙方、丙方的违约失信信息在平台网站进行公告，或以其他适当的方式公开披露。</p>
        <p class="agree-tx">6、如乙方未能按照本合同约定及时足额还款，乙方不可撤销地授权丁方指令存管银行随时划转乙方存管账户中的余额（如有）用以偿付乙方到期借款本息及其他费用（如有），该等划转无需另行征得乙方同意或通知乙方。如丙方未能按照本合同约定及时足额还款，丙方不可撤销地授权丁方指令存管银行随时划转丙方存管账户中的余额（如有）用以承担本合同项下的保证担保责任，该等划转无需另行征得丙方同意或通知丙方。</p>
        <p class="agree-tx">7、甲方和/或丙方为向乙方主张权利而支出的一切费用，包括但不限于诉讼费、律师费、鉴定费、执行费、评估费、登记费、保全费，均由乙方承担。</p>
        <br>
    ...
    <div class="agreement-area row" v-if="creditNum === '0' || cutRateType === 5">
      ...
      <div class="row">
        ...
        <p class="agree-tx" v-if="!cutContracts.userRealName">1.2 甲方明确知悉参与本活动，其在宏财网的协议编号为【&nbsp&nbsp&nbsp】，出借期望年均回报率由【&nbsp&nbsp&nbsp】降为【&nbsp&nbsp&nbsp】，多余部分作为宏财网的服务费，由宏财网在借款人每期还款时自动扣取。</p>
        <p class="agree-tx" v-if="cutContracts.userRealName">1.2 甲方明确知悉参与本活动，其在宏财网的协议编号为【{{cutContracts.contractNumber}}】，出借期望年均回报率由【{{cutContracts.oldRate}}%】降为【{{cutContracts.newRate}}%】，多余部分作为宏财网的服务费，由宏财网在借款人每期还款时自动扣取。</p>
