<template>
  <div class="agreement-area row">
    <p class="text-title">宏财网服务协议模版</p>
    ...
    <div class="row">
      ...
      <div class="col-md-10 col-md-offset-2 tbl">
        <table border="1">
          ...
          <tr>
            ...
            <td width="400" align="center">详情见附件1《还款计划表》</td>
          </tr>
          <tr>
      ...
      <p class="agree-tx">3.1.3按月等额本息还款法按每个月还款，还款日为每期末月的（20日/借款发放日对应日）。如无借款发放日对应日，以所在期末月的最后一日为还款日。计算公式如下：</p>
      ...
      <br>
      <br>
      <p><strong class="agree-mg">甲方（出借人）</strong>（签字）：</p>
      <br>
      <br>
      <br>
      <br>
      <br>
      <p><strong class="agree-mg">乙方（借款人） </strong>（盖章）：</p>
      <p class="agree-tx">法定代表人/授权代表（签字）：</p>
      <br>
      <br>
      <br>
      <br>
      <br>
      <p><strong class="agree-mg">丙方（居间人）</strong>（盖章）：</p>
      <p class="agree-tx">法定代表人/授权代表（签字）：</p>
      <br>
      <br>
      <br>
      <br>
      <br>
      <p class="agree-tx">*此模板仅为模板，具体协议以各方最终签订为准。</p>
      <br>
      <br>
      <br>
      <br>
